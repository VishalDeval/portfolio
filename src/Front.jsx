...
const Front = () => {
  return (
    <>
      <div className="relative flex flex-col items-center w-full my-20 p-0 gap-0 h-auto bg-gray-300">
        ...
        <img
          src={meImage}
          className="absolute bottom-0 left-1/2 -translate-x-1/2 h-48 md:h-80 object-contain pointer-events-none"
        />
      </div>
